...
const MOCK_BOOKINGS = [
  {
    bookingId: "BK-A1B2C3",
    hotel: { hotelName: "The Grand Mumbai", city: "Mumbai" },
    hotelRoomType: { roomTypeName: "Deluxe Room" },
    startDate: "2026-04-10",
    endDate: "2026-04-13",
    finalAmount: 21675,
    bookingStatus: "CONFIRMED",
    bookingType: "ONLINE",
    payment: { paymentMode: "UPI", paymentStatus: "SUCCESS" },
  },
  {
    bookingId: "BK-D4E5F6",
    hotel: { hotelName: "Goa Beach Resort", city: "Goa" },
    hotelRoomType: { roomTypeName: "Sea View Suite" },
    startDate: "2026-03-01",
    endDate: "2026-03-05",
    finalAmount: 19200,
    bookingStatus: "COMPLETED",
    bookingType: "ONLINE",
    payment: { paymentMode: "CARD", paymentStatus: "SUCCESS" },
  },
  {
    bookingId: "BK-G7H8I9",
    hotel: { hotelName: "Jaipur Heritage Villa", city: "Jaipur" },
    hotelRoomType: { roomTypeName: "Heritage Room" },
    startDate: "2026-05-20",
    endDate: "2026-05-23",
    finalAmount: 33075,
    bookingStatus: "CREATED",
    bookingType: "ONLINE",
    payment: { paymentMode: "NET_BANKING", paymentStatus: "PENDING" },
  },
];
...
export default function DashboardPage() {
  ...
  const upcomingCount = bookings.filter((b) =>
    ["CREATED", "CONFIRMED"].includes(b.bookingStatus),
  ).length;
            ...
            <div className="card p-5 space-y-4">
              {[
                ...
                >
                  ...
                  <span className={`font-display font-bold ${stat.color}`}>
                    {stat.value}
                  </span>
                </div>
              ))}
                ...
                {loading ? (
                  ...
                  <div className="space-y-4">
                    {bookings.map((booking) => {
                      const statusCfg =
                        STATUS_CONFIG[booking.bookingStatus] ||
                        STATUS_CONFIG.CREATED;
                      const canCancel = ["CREATED", "CONFIRMED"].includes(
                          ...
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                  className={`badge text-xs ${statusCfg.color}`}
                                >
                                  {statusCfg.label}
                                </span>
                              </div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 rounded-xl p-4 mb-4 text-sm">
                            <div>
                              ...
                              <p className="font-medium text-brand-dark">
                                {booking.hotelRoomType?.roomTypeName}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs text-gray-400 mb-0.5">
                  ...
                  {[
                    ...
                    <div key={field.key}>
                      ...
                      <input
                        ...
                        readOnly={field.key === "provider"}
                      />
                    </div>
                  ))}
                </div>
                <button className="btn-primary mt-6 px-8 py-3 text-sm">
                  Save Changes
                </button>
              </div>
            )}
            ...
            {activeTab === "preferences" && (
              <div className="card p-8 animate-fade-up">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Personalize your experience and get better recommendations.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {[
                    {
